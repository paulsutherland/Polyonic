...
class _View_ContactPage0 extends import1.AppView<import3.ContactPage> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._List_11_3; }
    if (((token === import14.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._Content_9_4.ngOnInit(); }
    const currVal_3:any = 'ionic';
    ...
    const currVal_4:any = this._Icon_18_3._hidden;
...
export function viewFactory_ContactPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ContactPage> {
  if ((renderType_ContactPage === (null as any))) { (renderType_ContactPage = viewUtils.createRenderComponentType('/Users/psutherland/Desktop/Polyonic/src/.tmp/pages/contact/contact.html',0,import9.ViewEncapsulation.None,styles_ContactPage,{})); }
